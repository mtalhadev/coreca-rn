...
import { GetSiteAndAttendanceParam, getSiteAndAttendance } from "../../../src/usecases/attendance/WorkerAttendanceCase";
...
describe('getSiteAndAttendance case', () => {
    it('attendanceId == undefined && arrangementId == undefined test', async () => {
        const res = await getSiteAndAttendance({ attendanceId: undefined, arrangementId: undefined })
    ...
    it('attendanceId == undefined success test', async() => {
        ...
        const res = await getSiteAndAttendance({ ...params, attendanceId: undefined })
        console.log(res);
    ...
    it('success test', async() => {
        ...
        const res = await getSiteAndAttendance({ ...params })
        console.log(res);

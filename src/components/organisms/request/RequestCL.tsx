...
export type RequestProps = {
    ...
    requestedCompanies?: CompanyCLType[]
    displayRespondCount?: boolean
    noIcon?: boolean
    subArrangedWorkers?: WorkerCLType[]
    subRequests?: RequestCLType[]
    style?: ViewStyle
    data?: SiteCLType
...
export const RequestCL = React.memo((props: Partial<RequestProps>) => {
    const { request, style, displayRespondCount, displayHeader, iconSize, orderRequestCount, orderPresentCount, requestedCompanies, noIcon, subArrangedWorkers, subRequests, type, displayMeter } =
        props
    ...
    return (
        <View style={[style]}>
            ...
            <View
                ...
                <WorkerListCL
                    workers={subArrangedWorkers ?? (request?.requestMeter?.presentArrangements?.items?.map((arr) => arr.worker).filter((data) => data != undefined) as WorkerCLType[])}

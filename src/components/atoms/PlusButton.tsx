...
export const PlusButton = React.memo((props: Partial<PlusButtonProps>) => {
    ...
    return (
        ...
        >
            <Pressable
                ...
                style={[
                    {
                        backgroundColor: disabled ? THEME_COLORS.OTHERS.BORDER_COLOR : color ?? THEME_COLORS.BLUE.MIDDLE,
                        borderRadius: size,
                        alignItems: 'center',
            ...
            >
                <Icon style={{}} name={'plus'} width={size / 2} height={size / 2} fill={'#fff'} />
            </Pressable>
        </Animated.View>
    )
})
